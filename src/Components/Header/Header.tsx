    ...
    <>
      ...
      >
        <div className="w-11/12  flex flex-row justify-between items-center transition-all duration-300 ease-in">
          {/* Logo */}
          <Link to={"/"}>
            <h1 className="h-16 text-main-purple font-bold items-center flex flex-col justify-center text-lg">
              Sweeft Gallery
            </h1>
          </Link>
          {/* Desktop Navigation */}
        ...
        >
          {/* Mobile Logo */}
          <h1 className="h-16 w-fit m-2 text-main-purple font-bold text-3xl flex flex-col justify-center">
            Sweeft Gallery
          </h1>
